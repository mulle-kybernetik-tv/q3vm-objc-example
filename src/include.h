#ifndef q3vm_objc_example_include_h__
#define q3vm_objc_example_include_h__
...
/* This is a central include file to keep dependencies out of the library
   ...
   not "q3vm-objc-example-include.h" to keep the #include statements in the
...
#include "_q3vm-objc-example-include.h"
